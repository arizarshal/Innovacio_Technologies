...
<h2>BLOCKCHAIN BASED SERVICE AND SOLUTIONS</h2>
<div className="list">
<ul>
    <li>Coin Creation</li>
    <li>Wallet</li>
...
{/* Derive the gauss law from colums law */}
{/* Derive the integral form and the point form of gauss law */}
{/* A point charge of 30nanocolumb is located at the origin while the plane y=2 carrries the charge
20 nanocolumb/m^2. Find the electric flux density vector at point p(0,3,4) */}
...
{/* Blokchain Solutions for the Enterprise 01 */}

<div className="solution">
{/* <div className="sol-h1"><h1>Blockchain Solutions for the Enterprise</h1></div>
<div className="sol-p"><p>Industries adopting the next wave of digital business</p></div> */}
